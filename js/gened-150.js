...
var quiz = [
  ...
  {
    question: "After a long hike, she couldn't bear the pain in her feet more longer, so she decided to take off her shoes and walk with her feet bare, which eventually _____ blisters.",
    choices: ["bear", "bore", "bare", "bored"],
    correctAnswer: 1
  },
  {
    question: "Ano ang nagaganap na pagbabagong morpoponemiko sa salitang may salungguhit? Pakiusap ko sa iyo, <u>sarhan</u> mo ang bintana para hindi makapasok ang lamok.",
    choices: ["Pagkaltas", "Asimilasyon", "Paglapi", "Metatesis"],
    correctAnswer: 0
  },
  {
  ...
  {
    question: "According to the widely accepted five-kingdom system in biology, which category includes true bacteria, bacteria-like organisms, and blue-green algae?",
    choices: ["Kingdom Protista", "Kingdom Pantae", "Kingdom Fungi", "Kingdom Monera"],
    correctAnswer: 3
  },
  {
    question: "Whose contributions initiated the foundation of modern taxonomy, which involved developing a classification system using hierarchical categories that relied on the physical and behavioral traits of organisms?",
    choices: ["Charles Darwin", " Ernest Mayr", "Jean Baptiste de Lamarck", "Carolus Linnaeus "],
    correctAnswer: 3
  }, 
  {
    question: "The protein shell of a virus is made up of _____ ?",
    choices: ["Chitin", " Peptidoglycan", "Cellulose", " Capsid"],
    correctAnswer: 3
  },
  {
    question: "Governor General Narciso Claveria was responsible for the ______. ?",
    choices: [" Establishment of the Tobacco Monopoly", " Use of Spanish surname by Filipinos", "Establishment of the Galleon Trade", "Abolition of the Galleon Trade"],
    correctAnswer: 1
  },
  {
    question: "He is referred to as the “The Brain of Himagsikan”.",
    choices: [" Andres Bonifacio", " Apolinario Mabini", "Emilio Jacinto", "Marcelo H. del Pilar"],
    correctAnswer: 1
  },
  {
    question: "“The face that launched a thousand ships” refers to ________.",
    choices: ["Princess of the Nile", "Elizabeth Barrett Browning", "Helen of Troy", " Mary of Magdala"],
    correctAnswer: 2
  },
  {
    question: " Who is the most cultured of the reformists? ",
    choices: [" Andres Bonifacio", " Graciano Lopez Jaena", " Jose Rizal ", "  Marcelo H. del Pilar"],
    correctAnswer: 2
  },
  {
    question: "Sa pangungusap na “Mahina ang boses mo” ang salitang mahina ay isang?",
    choices: ["Pang-uri", "  Pang-abay", "  Panghalip", "  Pangdiwa"],
    correctAnswer: 0 
  },
  {
    question: "What will happen to a plant cell when it is placed in a hypertonic solution?",
    choices: ["The plant cell will rupture. ", "The plant cell will shrink. ", "The plant cell will have edema.", "No effect on the cell."],
    correctAnswer: 1
  },
  {
  ...
  {
    question: "What are the frozen layers of soil called in both the tundra and subarctic zones?",
    choices: ["frozenland", "icebed", "frostland", "permaforst"],
    correctAnswer: 3
  },
  {
    question: "Which Gladiator is equipped with a dagger and shield, and also dons a leather belt and leg band?",
    choices: [ "Retiarius", "Secutor", "Murmillo", "Thracian"],
    correctAnswer: 2
  },
  {
    question: "Which geographical location was the birthplace of the world's first nation state?",
    choices: ["Egypt", "America", "India", "China"],
    correctAnswer: 0
  },
  {
    question: "By implementing the separation of powers and creating a system of 'checks and balances,' what goal did the Framers aim to achieve?",
    choices: ["ensure equal representation", "prevent the misuse or abuse of power.", "promote economic prosperity", "preserve cultural heritage"],
    correctAnswer: 0
  },
  {
    question: "Which geographical location was the birthplace of the world's first nation state?",
  ...
  {
    question: "The longest river in the USA is the ____.",
    choices: ["Mississippi River", "Missouri River", "Colorado River", "Columbia River"],
    correctAnswer: 1
  },
  {
    question: 'In the Preamble, what phrase means "maintaining peace and order" in our country?',
    choices: ["promote general welfare", "promote justice", "secure the blessings of liberty", "insure domestic tranquility"],
    correctAnswer: 3
  },
  {
    question: "The largest dessert in the world is the ____.",
    choices: ["Great Victoria Desert", "Antarctic Desert", "Sahara Desert", "Kalahari Desert"],
    correctAnswer: 2
  },
  {
    question: "A ________ is originally a member of the middle class in France.",
    choices: ["nouveau riche", "noblesse", "proletariat", "bourgeois"],
    correctAnswer: 3
  },
  {
    question: "Which faith holds the belief that peace and problem-solving can be attained by practicing meditation?",
    choices: ["Buddhism", "Hinduism", "Taoism", "Sikhism"],
    correctAnswer: 0
  },
  {
    question: "Which faith incorporates the concept of the 4 Noble Truths?",
    choices: ["Buddhism", "Hinduism", "Taoism", "Sikhism"],
    correctAnswer: 0
  },
  {
    question: "He is the leader of the Nazi's during World",
    choices: ["Joseph Stalin", "Adolf Hitler", "Winston Churchill", "Benito Mussolini"],
    correctAnswer: 1
  },
  {
    question: "He is the leader of the Nazi's during World",
  ...
  {
    question: "Which branch of government is responsible for the implementation of laws?",
    choices: ["Legislative branch", "Executive branch", "Judicial branch", "Administrative branch"],
    correctAnswer: 1
  },
  {
    question: "What is the term used to describe the dominance and power asserted by one nation over less powerful nations?",
    choices: ["Hegemony", "Colonialism", "Imperialism", "Globalization"],
    correctAnswer: 2
  },
  {
    question: "Which of the following dates is the most ancient?",
    choices: [ "500 BC", "100 AD", "1500 CE", "10000 BCE"],
    correctAnswer: 3
  },
  {
    question: "A ___________ refers to a geographical area that shares at least one common characteristic.",
    choices: ["Country", "Continent", "Region", "City"],
    correctAnswer: 2
  },
  {
    question: "Who upheld the idea that the pursuit of knowledge should be guided by reason?",
    choices: ["Aristotle", "Plato", "Socrates", "Descartes"],
    correctAnswer: 0
  },
  {
    question: "Who proposed the concept that all matter is comprised of atoms?",
    choices: [ "Aristotle", "Democritus", "Newton", "Galileo"],
    correctAnswer: 1
  },
  {
    question: "The branch of government responsible for the interpretation of laws?",
    choices: ["Executive branch", "Legislative branch", "Judicial branch", "Administrative branch"],
    correctAnswer: 1
  },
  {
    question: "It is a place of prayer for Muslims.",
    choices: ["Mosque", "Synagogue", "Church", "Cathedral"],
    correctAnswer: 0
  },
  {
    question: "The religion that Lao-tzu founded is called ____.",
    choices: ["Hinduism", "Taoism", "Sikhism", "Shintoism"],
    correctAnswer: 1
  },
  {
    question: "What is the term used to describe a group of individuals who believe in the existence of multiple gods?",
    choices: ["Henotheism", "Pantheism", "Polytheism", "Atheism"],
    correctAnswer: 2
  },
  {
    question: 'What is the name of the vast tropical rainforest located primarily in South America, known for its rich biodiversity and often referred to as the "lungs of the Earth"?',
    choices: ["Serengeti Forest", "Evergreen Forest", "Congo Rainforest", "Amazon Rainforest"],
    correctAnswer: 3
  },
  {
    question: "What is the definition of an archipelago?",
    choices: [ "A mountain range", "A coastal region", "A single large island", "A group of islands"],
    correctAnswer: 3
  },
  {
  ...
  {
    question: "What is the term used to describe any alteration made to the constitution?",
    choices: ["Annexation", "Amendment", "Revocation", "Supplement"],
    correctAnswer: 1
  },  
  {
    question: "During which time period did the Age of Exploration take place?",
    choices: ["1450-1750", "1200-1400", "1600-1800", "1300-1500"],
    correctAnswer: 0
  },
  {
    question: "Who was the Greek poet known for writing the epic poems 'The Iliad' and 'The Odyssey'?",
    choices: ["Homer", "Sappho", "Euripides", "Aeschylus"],
    correctAnswer: 0
  },
  {
    question: "Ethan holds the belief that every event or occurrence in the world has a cause or a reason. Which scientific attitude is reflected in his perspective?",
    choices: ["Open-mindedness", "firm set of beliefs", "Intuition", "Dogmatism"],
    correctAnswer: 1
  },
  {
    question: "What is the primary objective of Human Rights Education?",
    choices: ["to promote discrimination", "to enforce authoritarian rule", "to generate awareness regarding one’s basic rights", "to suppress freedom of expression"],
    correctAnswer: 2
  },
  {
    question: "Between which two planets are the majority of asteroids typically located?",
    choices: ["Venus and Earth", "Mercury and Venus", "Saturn and Uranus", "Mars and Jupiter"],
    correctAnswer: 3
  },
  {
    question: "Determine the equation of a line with a slope of -2 and a y-intercept of 3.",
    choices: ["y = 2x + 3", "y = -2x + 3", "y = -2x - 3", "2x +y =3"],
    correctAnswer: 3
  },
  {
    question: "Nag-aaral ako ___ mabuti upang makapagtapos sa pag-aaral.",
    choices: ["nang", "sa", "ng", "mas"],
    correctAnswer: 2
  },
  {
    question: "What is the term used to refer to organisms that exclusively feed on plants?",
    choices: [ "Carnivores", "Herbivores", "Omnivores",  "Detritivores"],
    correctAnswer: 1
  },
  {
    question: "There are __ prime numbers between 1-100.",
    choices: [ "25", "27", "26",  "35"],
    correctAnswer: 0
  },
  {
    question: "If a square has an area of 400 sq. cm, what is the length of its perimeter?",
    choices: [ "80", "60", "20", "40"],
    correctAnswer: 0
  },
  {
    question: "If 500 or 25% of a graduating class consists of girls, what is the total number of students graduating?",
    choices: [ "2500", "2000", "5000", "2250"],
    correctAnswer: 1
  },
  {
    question: "If one cow weighs 100 pounds and the other cow weighs 150 pounds, how many times is the weight of the second cow compared to the first?",
    choices: [ "2 times", ".5 times", " 1.5 times", "1.2 times"],
    correctAnswer: 2
  },
  {
    question: "What is the term used to refer to organisms that have a diet consisting of both plants and animals?",
    choices: ["Carnivores", "Herbivores", "Detritivores", "Omnivores"],
    correctAnswer: 3
  },
...
displayQuestion();
  ...
  function refreshPage() {
    // Redirect to index.html
    window.location.href = "gened-150.php";
  }

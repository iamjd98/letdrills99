...
<head>
    ...
    <title>Prof Ed Menu - Time Limit</title>
</head>
<body>
...
<center><h3 class="mt-5 text-success">Professional Education Drills - Time Limit</h3></center>

      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
        <a href="profed-timed-50.php">
        <button  class="button-select  shadow-lg">
        <span class="fs-6 fw-bold">50 item Prof Ed Test</span><br>
        <span class="text-muted">(Random Questions + 1 Hr Time Limit)</span>
        </button>
        </a>
      </div>

      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
          <a href="profed-timed-150.php">
          <button  class="button-select  shadow-lg">
          <span class="fs-6 fw-bold">150 item Prof Ed Test</span><br>
          <span class="text-muted">(Random Questions + 3 Hrs Time Limit)</span>
          </button>
          </a>
      </div>
      ...
      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
        ...
        <button  class="button-select  shadow-lg">
        <span class="fs-6 fw-bold">300 item Prof Ed Test</span><br>
        <span class="text-muted">(Random Questions + 6hrs Time Limit)</span>
        </button>
        </a>
      </div> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Prof Ed 300 Question Drill</h1>

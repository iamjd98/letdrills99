...
<head>
    ...
    <title>Prof Ed - 150 Questions</title>
</head>
<body>
...
<div class="question-menu-wrapper">
  <div class="question-menu-con">
    ...
    <button onclick="ProfEdMenuPage()" class="btn btn-sm btn-success w-25" type="button">Prof Ed Menu</button>

  </div>
</div>


<script src="./js/profed-150.js"></script>

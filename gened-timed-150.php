...
<head>
    ...
    <title>Gen Ed 150 Questions - Time Limit</title>
</head>
<body>
...
<div class="question-menu-wrapper">
  <div class="question-menu-con">
    ...
    <button onclick="TimedGenEdMenuPage()" class="btn btn-sm btn-success w-25" type="button">Gen Ed Menu</button>
  </div>
</div>



<script src="./js/gened-timed-150.js"></script>

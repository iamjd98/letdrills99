...
<div id="menu-container" class="menu-container m-0 p-0 row mt-5">

      <center><h3 class="mt-5 text-success">Professional Education Drills</h3></center>

      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
        <a href="profed-50.php">

...
<head>
    ...
    <title>Gen Menu - Time Limit</title>
</head>
<body>
...
<center><h3 class="mt-5 text-success">General Education Drills - Time Limit</h3></center>

      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
        <a href="gened-timed-50.php">
        <button  class="button-select  shadow-lg">
        <span class="fs-6 fw-bold">50 item Gen Ed Test</span><br>
        <span class="text-muted">(Random Questions + 40 Minutes Time Limit)</span>
        </button>
        </a>
      </div>

      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
          <a href="gened-timed-150.php">
          <button  class="button-select  shadow-lg">
          <span class="fs-6 fw-bold">150 item Gen Ed Test</span><br>
          <span class="text-muted">(Random Questions + 2 Hrs Time Limit)</span>
          </button>
          </a>
      </div>
      ...
      <div class="buttons d-flex justify-content-center col-lg-4 col-md-6 m-0 p-0">
        ...
        <span class="text-muted">(Random Questions + 4hrs Time Limit)</span>
        </button>
        </a>
      </div> 
